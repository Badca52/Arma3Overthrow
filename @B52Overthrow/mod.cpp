name = "Overthrow 0.7.6.0";     //This name will be displayed only in game , specifically the expansion menu
...
description = "Overthrow - Version 0.7.6.0"; // Addon Description
